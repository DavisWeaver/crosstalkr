...
Crosstalkr is designed to facilitate the identification of functional subnetworks in human or non-human interactomes. 
...
# Statement of Need
 ...
 - Literature Review
 - Discuss shortcomings in the literature/ unmet need
 - Discuss utility of this type of functional enrichment assay

# Design and Data Sources

 - Need to talk about different available Protein-protein interaction networks
 - Some kind of flow chart organizing the different modules/ data sources

# Functionality
 - compute_crosstalk is the big one
 - show compute crosstalk for diffent biological networks + non-biological examples
 - also highlight the prep_ppi functionality that folks can use and some of the other utils

# Outlook
 - Resummarize contribution
 - Position in the literature/ among the broader bioinformatic toolkit. 
 - Talk about where this sort of analysis may be useful
